...
<asp:Content runat="server" ContentPlaceHolderID="mainBody">
    ...
    <asp:Panel runat="server" ID="pFirst">
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-8">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtPrimaryEmail"
                    CssClass="error smallFont" Display="Dynamic" ErrorMessage="RequiredFieldValidator" ForeColor="DarkRed" SetFocusOnError="True">Primary Email is required</asp:RequiredFieldValidator>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-10">
                ...
                <asp:DropDownList ID="ddlRegion" runat="server" CssClass="form-control smallFont" Height="33px"></asp:DropDownList>
        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12">
                <strong>
                    <label for="txtSpecialNeeds">For Available Accommodations, please call (806) 281-5701 or (806) 281-5715.</label></strong>
            </div>
        </div>
        <br />
        <div class="row">
            <div class="col-xs-12 col-sm-6">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator11" runat="server" ForeColor="DarkRed" ErrorMessage="Password is required" ControlToValidate="txtPassword" CssClass="error"></asp:RequiredFieldValidator>
            </div>
            ...
            <div class="col-xs-12 col-sm-6">
                ...
                <asp:CompareValidator ID="CompareValidator1" runat="server" CssClass="error smallFont"
                    ForeColor="DarkRed" ErrorMessage="Password must match" ControlToCompare="txtPassword" ControlToValidate="txtConfirmPassword"></asp:CompareValidator>
            </div>
    ...
    <asp:Panel runat="server" ID="pSuccess" Visible="false">
        Your account has been created. <a href="~/default.aspx" runat="server" class="link">Please click here to continue</a>
    </asp:Panel>
    <br />
</asp:Content>
