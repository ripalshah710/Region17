...
public partial class Barcode_QRAttendee : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            // string attendee_id = "1434879";// Request.QueryString["ID"].ToString(); attendee_id or user_id
            ...
            if (isValidipAddr)
            {
                ...
                using (SqlCommand SQLCommand = new SqlCommand("[/qrcode/multidates/attendance]", SQLConn2))
                {
                    ...
                    {
                        Response.Write(ex.Message);
                        System.Diagnostics.EventLog.WriteEntry("QRCode:", ex.Message, System.Diagnostics.EventLogEntryType.Error);
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        try
        {
            ...
            using (SqlCommand SQLCommand = new SqlCommand("[/qrcode/validipaddr2]", SQLConn))
            {
            ...
            if (isValidipAddr)
            {
                ...
                using (SqlCommand SQLCommand = new SqlCommand("[/qrcode/singleday/attendance]", SQLConn2))
                {
                    SQLCommand.CommandType = CommandType.StoredProcedure;
                    SQLCommand.Parameters.AddWithValue("@attendeeID", Convert.ToInt32(attendee_id));
                  ...
                  //  SQLCommand.Parameters.Add("@count", SqlDbType.Int, 4).Direction = ParameterDirection.Output;
                    ...
                    {
                        SQLCommand.ExecuteNonQuery();
                        firstname = SQLCommand.Parameters[2].Value.ToString();
                        lastname = SQLCommand.Parameters[3].Value.ToString();
