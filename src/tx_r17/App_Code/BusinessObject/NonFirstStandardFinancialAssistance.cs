...
{
    [Serializable()]
    public class NonFirstStandardFinancialAssistance : BusinessBase<NonFirstStandardFinancialAssistance>
    {
        #region Properties
        ...
        private NonFirstStandardFinancialAssistance()
        { /* require use of factory methods */ }

        internal static NonFirstStandardFinancialAssistance NewNonFirstStandardFinancialAssistance()
        {
            return DataPortal.CreateChild<NonFirstStandardFinancialAssistance>();
        }

        internal static NonFirstStandardFinancialAssistance GetNonFirstStandardFinancialAssistance(SafeDataReader dr)
        {

            return DataPortal.FetchChild<NonFirstStandardFinancialAssistance>(dr);
        }
        ...
        public static NonFirstStandardFinancialAssistance CreateNew()
        {
            return NewNonFirstStandardFinancialAssistance();
        }
        ...
        protected void Child_Insert(Assistance assistance, SqlConnection cn)
        {
            if (this.IsNew)
            {
                using (SqlCommand cmd = cn.CreateCommand())
                {
                    ...
                    cmd.CommandText = "ItsNonFirstStandardFinancialAssistanceInsert";
        ...
        protected void Child_DeleteSelf(escWorks.BusinessObjects.Assistances a)
        {
            if (this.IsDeleted)
            {
                using (SqlConnection cn = region4.Common.DataConnection.DbConnection)
                {
                    ...
                    {
                        cmd.CommandType = CommandType.StoredProcedure;
                        cmd.CommandText = "ItsNonFirstStandardFinancialAssistanceDelete";
